...
class ApiProvider {
  ...
  Future<GetDueAmountByDay> getDueAmountByVendorId() async {
    try {
      Map input = HashMap<String, dynamic>();
      ...
      input["vendor_id"] =
          await SharedPref.getIntegerPreference(SharedPref.VENDORID);
      Response res = await dio.post(
        Endpoint.Get_Due_Amount,
        data: input,
      );
      return GetDueAmountByDay.fromJson(res.toString());
    } catch (error) {
      String message = "";
      if (error is DioError) {
        ServerError e = ServerError.withError(error: error);
      ...
      print("Exception occurred: $message stackTrace: $error");
      return GetDueAmountByDay(success: false, message: message);
    }
  }
  ...
  Future<GetMyChatPapdiCustomerResponse> getChatPapdiCustomer(
      Map<String, dynamic> input) async {
    try {
      Response res =
  ...
  Future<UpiHistroyOrdersResponse> upiPaymentHistoryDetail(
      Map<String, dynamic> input) async {
    try {
      Response res =
          await dio.post(Endpoint.UPI_PAYMENT_HISTORY_DETAIL, data: input);
  ...
  Future<UpiHistroyOrdersLedgerResponse> upiPaymentHistoryDetailLedger(
      Map<String, dynamic> input) async {
    try {
      Response res = await dio.post(Endpoint.UPI_PAYMENT_HISTORY_DETAIL_LEDGER,
          data: input);
      ...
      print("Exception occurred: $message stackTrace: $error");
      return UpiHistroyOrdersLedgerResponse(
          success: false, message: "", data: []);
    }
  }

  Future<IntiatePaymnetResponse> initiatePayment(
      Map<String, dynamic> input) async {
    try {
      Response res =
          await dio.post(Endpoint.GET_INITIATE_PAYMENT_RESPONSE, data: input);
