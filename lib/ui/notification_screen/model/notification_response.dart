...
class NotificationResponse {
  ...
  factory NotificationResponse.fromMap(Map<String, dynamic> json) => NotificationResponse(
        ...
        data: json["data"] == null
            ? null
            : List<NotificationData>.from(json["data"].map((x) => NotificationData.fromMap(x))),
      );
...
class NotificationData {
  ...
  Map<String, dynamic> toMap() => {
        ...
        "notification_data_details": notificationDataDetails == null ? [] : notificationDataDetails!.toMap(),
      };
}
