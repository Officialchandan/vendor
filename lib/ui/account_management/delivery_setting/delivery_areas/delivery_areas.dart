...
class _DeliveryAreasState extends State<DeliveryAreas> {
  ...
  List<String> DeliveryAreasText = ["345, Harrison Avenue", "4780, Old Narcross Road"];
    ...
    return SafeArea(
      child: Scaffold(
                  ...
                  children: [
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        labelText: "Add serviceable radius",
                        labelStyle: TextStyle(color: Color(0xff555555), fontSize: 14, fontWeight: FontWeight.w500),
                        suffixText: "KM",
                        suffixStyle: TextStyle(color: Color(0xff555555), fontSize: 14, fontWeight: FontWeight.w600),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        contentPadding: EdgeInsets.only(bottom: 6),
                        labelText: "Add serviceable areas",
                        labelStyle: TextStyle(color: Color(0xff555555), fontSize: 14, fontWeight: FontWeight.w500),
                        enabledBorder: UnderlineInputBorder(
                          borderSide: BorderSide(width: 1, color: Color(0xff555555)),
                        ),
                    ...
                    SizedBox(height: 20),
                    Text("Serviceable areas",style: TextStyle(color: Colors.black, fontSize: 15, fontWeight: FontWeight.w600)),
                  ],
                ),
              ),
                ...
                children: List.generate(DeliveryAreasText.length, (index){
                  return Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(DeliveryAreasText[index], style: TextStyle(color: Color(0xff555555), fontSize: 15, fontWeight: FontWeight.w600)),
        ...
        bottomNavigationBar: MaterialButton(
          ...
          child: Text("DONE", style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w600)),
          color: ColorPrimary,
