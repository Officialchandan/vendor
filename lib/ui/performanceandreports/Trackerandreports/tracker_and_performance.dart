...
class TrackerReportsScreen extends StatefulWidget {
  @override
  _TrackerReportsScreenState createState() => _TrackerReportsScreenState();
}

class _TrackerReportsScreenState extends State<TrackerReportsScreen> {
  ...
  final options = [
    {
      ...
      "subTitle": "click here to see Performance",
      "image": "assets/images/inventory-h2.png",
      "id": 1
    },
    {
      "title": "Reports",
      "subTitle": "click here to see reports",
      "image": "assets/images/inventory-h2.png",
      "id": 2
    },
    {
      "title": "Money due - UPI",
      "subTitle": "click here to see Money due - UPI",
