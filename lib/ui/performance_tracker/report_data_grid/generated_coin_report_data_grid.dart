...
class GeneratedCoinReportDataGrid extends StatefulWidget {
  ...
  @override
  _GeneratedCoinReportDataGridState createState() =>
      _GeneratedCoinReportDataGridState();
}

class _GeneratedCoinReportDataGridState
    extends State<GeneratedCoinReportDataGrid> {
  ...
  ReportDataSource({required List<Map<String, dynamic>> reportData}) {
    _reportData = reportData
        .map<DataGridRow>((e) => DataGridRow(cells: [
              ...
              DataGridCell<String>(
                  columnName: 'Monetary Value',
                  value: e['monetary_value'].toString()),
            ]))
        .toList();
  }
