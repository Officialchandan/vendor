...
class _DailySaleAmountState extends State<DailySaleAmount> implements PerformanceTrackerListner {
  ...
  getDhabasDay({catid, productid, date}) async {
    resultDaily = (await ApiProvider()
        .getDailySaleAmount(catid == null ? "" : catid, productid == null ? "" : productid, date == null ? "" : date));
                      ...
                      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Container(
                            ...
                            child: Align(
                              ...
                              child: Text("  " + "day_key".tr(), style: TextStyle(fontSize: 20.0, color: ColorPrimary)),
                            ))
                      ]),
                      Container(
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    TableRow(children: [
                      ...
                      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Container(
                            ...
                            child: Align(
                              alignment: Alignment.centerLeft,
                              child: Text('  ${(double.parse(snapshot.data!.todaySaleAmount)).toStringAsFixed(2)}',
