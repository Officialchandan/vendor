...
class UpiRedeemCoinResponse {
  ...
  factory UpiRedeemCoinResponse.fromJson(String str) => UpiRedeemCoinResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory UpiRedeemCoinResponse.fromMap(Map<String, dynamic> json) => UpiRedeemCoinResponse(
        success: json["success"] == null ? "" : json["success"],
        message: json["message"] == null ? "" : json["message"],
        normalBilling:
            json["data"] == null ? [] : List<CoinDetail>.from(json["data"].map((x) => CoinDetail.fromMap(x))),
        directBilling: json["direct_billing"] == null
            ? []
            : List<CoinDetail>.from(json["direct_billing"].map((x) => CoinDetail.fromMap(x))),
      );

  Map<String, dynamic> toMap() => {
        "success": success == null ? "" : success,
        "message": message == null ? "" : message,
        "data": normalBilling == null ? [] : List<dynamic>.from(normalBilling.map((x) => x.toMap())),
...
class CoinDetail {
  ...
  factory CoinDetail.fromJson(String str) => CoinDetail.fromMap(json.decode(str));
  ...
  factory CoinDetail.fromMap(Map<String, dynamic> json) => CoinDetail(
        ...
        totalRedeemCoins: json["total_redeem_coins"] == null ? "" : json["total_redeem_coins"].toString(),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "total_redeem_coins": totalRedeemCoins == null ? null : totalRedeemCoins,
        "order_details": orderDetails == null ? [] : List<dynamic>.from(orderDetails.map((x) => x.toMap())),
