  ...
  Widget build(BuildContext context) {
    return BlocProvider<DirectBillingCustomerNumberResponseBloc>(
      ...
      child: Scaffold(
        ...
        body: BlocConsumer<DirectBillingCustomerNumberResponseBloc,
                DirectBillingCustomerNumberResponseState>(
            listener: (context, state) async {
          if (state is GetDirectBillingDueAmoutResponseState) {
            isFlashLineShow =
                    ...
                    listener: (context, state) {
                      ...
                      if (state is GetDirectBillingOtpState) {
                        ...
                        datas!.remainingOrdAmt == "0"
                            ?
                            /*! uncamment these line if u want Cumulative dilog*/
                            //_displayCumulative(context,
                            //     datas!.remainingOrdAmt, datas!.freeGiftName)
                            //  .then((value) {
