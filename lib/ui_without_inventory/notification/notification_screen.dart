...
class WithoutInventoryNotificationScreen extends StatefulWidget {
  ...
  const WithoutInventoryNotificationScreen(
      {Key? key, required this.notificationData})
      : super(key: key);

  @override
  State<WithoutInventoryNotificationScreen> createState() =>
      _WithoutInventoryNotificationScreenState();
}

class _WithoutInventoryNotificationScreenState
    extends State<WithoutInventoryNotificationScreen> {
