...
class LoginResponse {
  ...
  factory LoginResponse.fromMap(Map<String, dynamic> json) => LoginResponse(
        ...
        deviceToken:
            json["device_token"] == null ? "" : json["device_token"].toString(),
        vendorCoins:
            json["vendor_coins"] == null ? "" : json["vendor_coins"].toString(),
        commission: json["vendor_commission"] == null
            ? ""
            : json["vendor_commission"].toString(),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "vendor_commission": commission == null ? null : commission,
      };
}
